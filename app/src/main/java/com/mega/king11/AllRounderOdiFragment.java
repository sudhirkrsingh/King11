...
public class AllRounderOdiFragment extends Fragment {
    RadioButton button1,button2,button3,button6,button7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url ="https://drive.google.com/uc?export=download&id=1GH3fOI6cDwWxvHdLvW7pqwoR7_FcWxyb";
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction fr=getFragmentManager().beginTransaction();
                fr.replace(R.id.Frame,new AllRounderTestFragment());
                fr.commit();
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction fr=getFragmentManager().beginTransaction();
                fr.replace(R.id.Frame,new AllRounderT20Fragment());
                fr.commit();
