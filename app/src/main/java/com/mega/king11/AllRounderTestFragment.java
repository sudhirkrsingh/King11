...
public class AllRounderTestFragment extends Fragment {
    RadioButton button1,button2,button3,button5,button7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url ="https://drive.google.com/uc?export=download&id=1m4vaJEf-OuWNlUcccUC7YY3Efh-7Ezze";
