...
public class BatsmenT20Fragment extends Fragment {
    RadioButton button1,button3,button4,button5,button6;
    RecyclerView recyclerView;
    ArrayList<FetchRankPlayer> mExampleList2;
    RankPlayerAdapter rankPlayerAdapter;
    RequestQueue requestQueue;

    public BatsmenT20Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_batsmen_t20, container, false);
        ...
        String url ="https://drive.google.com/uc?export=download&id=1L2f56GS692cQ7KQL-1nGm5H7F0imgpLX";
