...
public class BatsmenTestFragment extends Fragment {
    RadioButton button1,button3,button4,button5,button7;
    RecyclerView recyclerView;
    ArrayList<FetchRankPlayer> mExampleList2;
    RankPlayerAdapter rankPlayerAdapter;
    RequestQueue requestQueue;

    public BatsmenTestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_batsmen_test, container, false);
        ...
        String url ="https://drive.google.com/uc?export=download&id=17PaNMkqsPrsZzjLAlDHxeQYslckQrqGW";
