...
public class BowlerOdiFragment extends Fragment {
    RadioButton button1,button2,button4,button6,button7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url ="https://drive.google.com/uc?export=download&id=1bYaN5inactrSl6FcfNaD2Onx1DO0riQ8";
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentTransaction fr=getFragmentManager().beginTransaction();
                fr.replace(R.id.Frame,new BowlerTestFragment());
                fr.commit();
