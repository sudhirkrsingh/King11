...
public class TeamOdiFragment extends Fragment {
    RadioButton button2,button3,button4,button6,button7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url ="https://drive.google.com/uc?export=download&id=1GUNtJr-gqTW8PYWiScprAxyhsfuBSv6o";
